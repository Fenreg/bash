...
#d ephck_ROS.exe), this code produces a serie of ephemerids.
#d
#d Changelog:
#d    2015 Nov 04 v1.0 First light
#d    2016 Aug 16 v1.1 Spring cleaning, script clarification
#d    2016 Feb 13 v1.2 Modify for portability to lesia08
#d
#d Dependances:
#d    OASIS - ephck_ROS.exe (ephck_ROS.exe + modifications)
...
#c Checking if the ephemerids particulars and the program can be found.
  ...
  OasisScript="ephck_ROS.exe";
  Path2Kernel="/home/user-777/These/Tycho/SPICE";
  SpiceFurnsh="ephck.txt";
