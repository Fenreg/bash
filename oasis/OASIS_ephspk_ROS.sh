...
#d ephspk_ROS.exe), this code produces a serie of ephemerids.
#d
#d Changelog:
#d    2015 Nov 04 v1.0 First light
#d    2O16 Aug 16 v1.1 Spring cleaning, script clarification
#d    2017 Feb 13 v1.2 Modifying for portability to lesia08
#d
#d Dependances:
#d    OASIS - ephspk_ROS.exe (ephspk_ROS.exe + modifications)
